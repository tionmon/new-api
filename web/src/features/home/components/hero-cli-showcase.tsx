...
export function HeroCliShowcase({ className }: { className?: string }) {
  ...
  const cliProfiles: CliProfile[] = [
    {
      ...
      renderOutput: () => (
        <div className='space-y-3.5 font-mono text-[13.5px] leading-relaxed'>
          <div className='flex items-center justify-between text-neutral-700 dark:text-neutral-300'>
            ...
            <span className='text-xs text-neutral-500 dark:text-neutral-400'>
              Dispatch: OpenAI Official Direct
            </span>
          </div>
          <div className='space-y-2.5 border-l-2 border-neutral-300 pl-4 text-neutral-700 dark:border-neutral-700/60 dark:text-neutral-300'>
            ...
            <div className='rounded-lg border border-emerald-500/30 bg-emerald-50/90 p-3 text-[12px] text-emerald-800 dark:border-emerald-500/20 dark:bg-emerald-500/10 dark:text-emerald-300'>
              ✔ Executing Current Test Suite: 36/36 integration tests passed
              (100% success rate)
            </div>
            <div className='rounded-lg border border-neutral-200 bg-neutral-100/80 p-2.5 text-[12px] text-neutral-700 dark:border-neutral-800 dark:bg-neutral-900/60 dark:text-neutral-300'>
              ...
              e2e_gateway_auth_test • 0 errors • SSE streaming verified
            </div>
            <div className='flex items-center justify-between border-t border-neutral-200/70 pt-1.5 text-[12px] text-neutral-600 dark:border-neutral-800/70 dark:text-neutral-400'>
              <span>Tokens: 1,680 in / 420 out • Cache Hit: 95%</span>
              <span className='font-semibold text-emerald-600 dark:text-emerald-400'>
                Speed: 76.8 tok/s • Latency: 21ms
              </span>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      icon: 'Cursor',
      command:
        'cursor --model deepseek --stream "Implement overflow-safe quota math"',
      renderOutput: () => (
        <div className='space-y-3.5 font-mono text-[13.5px] leading-relaxed'>
          <div className='flex items-center justify-between text-neutral-700 dark:text-neutral-300'>
            <span className='font-semibold text-neutral-800 dark:text-neutral-200'>
          ...
          <div className='space-y-2.5 text-neutral-800 dark:text-neutral-200'>
            ...
            <div className='space-y-1.5 rounded-lg border border-neutral-200 bg-neutral-100/90 p-3 text-[12px] text-neutral-800 dark:border-neutral-800 dark:bg-neutral-900/80 dark:text-neutral-200'>
              ...
              <p className='leading-relaxed text-neutral-600 dark:text-neutral-300'>
                To prevent arithmetic overflow during multi-currency token
                billing, calculate quota using common.QuotaRoundChecked to
                capture clamping metadata and guarantee safe int32 bounds...
              </p>
            </div>
            <div className='rounded-lg border border-neutral-200 bg-neutral-100/70 p-2.5 text-[12px] text-neutral-700 dark:border-neutral-800 dark:bg-neutral-900/50 dark:text-neutral-300'>
              ...
              <div className='text-emerald-600 dark:text-emerald-400'>
                + return QuotaRoundChecked(computedQuota)
              </div>
            </div>
            <div className='flex items-center justify-between pt-1 text-xs text-emerald-600 dark:text-emerald-400'>
              <span>
                Commit 7386a1: feat(billing): enforce overflow-safe quota math
              </span>
        ...
        <div className='space-y-3.5 font-mono text-[13.5px] leading-relaxed'>
          ...
          <div className='space-y-2.5 text-neutral-800 dark:text-neutral-200'>
            ...
            <div className='rounded-lg border border-neutral-200 bg-neutral-100/70 p-3 text-[12.5px] leading-relaxed text-neutral-700 dark:border-neutral-700/60 dark:bg-neutral-900/60 dark:text-neutral-300'>
              Direct official OpenAI endpoint dispatch powered by dedicated GPT
              Pro 20X acceleration. Engineered for extreme zero-jitter
              stability, 20x concurrency burst endurance, and guaranteed
              zero-loss quota settlement.
            </div>
            ...
            <div className='flex items-center justify-between border-t border-neutral-200 pt-2 text-[11.5px] text-neutral-600 dark:border-neutral-800/80 dark:text-neutral-400'>
              ...
              <span className='font-semibold text-emerald-600 dark:text-emerald-400'>
                State: Ultra-Stable • Quota Verified
              </span>
            </div>
          </div>
        </div>
        ...
        <div className='space-y-3.5 font-mono text-[13.5px] leading-relaxed'>
          ...
          <div className='grid grid-cols-2 gap-2.5 text-xs'>
            <div className='rounded-lg border border-neutral-200 bg-white p-3 shadow-xs dark:border-neutral-800/80 dark:bg-neutral-900/50'>
              <div className='text-[10px] text-neutral-500 uppercase dark:text-neutral-400'>
                P50 / P99 Latency
              </div>
              <div className='font-mono text-base font-bold text-neutral-900 dark:text-white'>
                11.2ms / 38ms
              </div>
            </div>
            <div className='rounded-lg border border-neutral-200 bg-white p-3 shadow-xs dark:border-neutral-800/80 dark:bg-neutral-900/50'>
  ...
  return (
    <div
      className={cn(
        'relative w-full max-w-2xl xl:max-w-[700px] group',
        className
      )}
    ...
    >
      ...
      <div
        aria-hidden
        className='pointer-events-none absolute -inset-2 rounded-3xl bg-radial from-neutral-500/10 via-neutral-500/5 to-transparent opacity-60 blur-2xl transition-opacity duration-500 dark:from-white/5 dark:opacity-30'
      />
      ...
      <div className='relative overflow-hidden rounded-2xl border border-neutral-200/90 bg-white text-neutral-900 shadow-[0_20px_50px_rgba(0,0,0,0.06)] dark:border-white/10 dark:bg-[#0c1017] dark:text-neutral-100 dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)]'>
        ...
        <div className='border-b border-neutral-200/90 bg-neutral-100/90 px-5 py-3.5 dark:border-white/10 dark:bg-[#131823]/95'>
          ...
          <div className='no-scrollbar flex items-center gap-1.5 overflow-x-auto pt-0.5'>
        ...
        <div className='min-h-[380px] overflow-y-auto bg-neutral-50/50 p-6 md:min-h-[430px] md:p-8 dark:bg-[#0a0d14]/90'>
